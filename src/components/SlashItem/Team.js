          ...
          <div className="container">
              ...
              <div className="row">
                  <div className="col s12 m3">
                      <div className="card card-avatar">
                          <div className="waves-effect waves-block waves-light">
                              <img role="presentation" className="activator" src="img/avatar1.png" />
                          </div>
                          <div className="card-content">
                              <span className="card-title activator grey-text text-darken-4">Flash <br/>
                                  <small><em><a className="red-text text-darken-1" href="#">CEO</a></em></small></span>
                              <p>
                  ...
                  <div className="col s12 m3">
                      <div className="card card-avatar">
                          <div className="waves-effect waves-block waves-light">
                              <img role="presentation" className="activator" src="img/avatar2.png" />
                          </div>
                          <div className="card-content">
                  ...
                  <div className="col s12 m3">
                      <div className="card card-avatar">
                          <div className="waves-effect waves-block waves-light">
                              <img role="presentation" className="activator" src="img/avatar3.png" />
                          </div>
                          <div className="card-content">
                              <span className="card-title activator grey-text text-darken-4">
                                  Capt. America <br/>
                                  <small><em><a className="red-text text-darken-1" href="#">CMO</a></em></small></span>
                              <p>
                                  <a className="blue-text text-lighten-2" href="https://www.facebook.com/joash.c.pereira">
                                      <i className="fa fa-facebook-square"></i>
                                  </a>
                  ...
                  <div className="col s12 m3">
                      <div className="card card-avatar">
                          <div className="waves-effect waves-block waves-light">
                              <img role="presentation" className="activator" src="img/avatar4.png" />
                          </div>
                          <div className="card-content">
